...
namespace PawMates.Data.Migrations
{
    ...
    [Migration("20240417093935_LikeTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.IdentityModels.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.IdentityModels.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("PawMates.Infrastructure.Data.IdentityModels.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PawMates.Infrastructure.Data.IdentityModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.Models.Event", b =>
                {
                    b.HasOne("PawMates.Infrastructure.Data.IdentityModels.ApplicationUser", "Organiser")
                        .WithMany()
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.Models.EventParticipant", b =>
                {
                    ...
                    b.HasOne("PawMates.Infrastructure.Data.IdentityModels.ApplicationUser", "Helper")
                        .WithMany()
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.Models.Like", b =>
                {
                    ...
                    b.HasOne("PawMates.Infrastructure.Data.IdentityModels.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.Models.Pet", b =>
                {
                    b.HasOne("PawMates.Infrastructure.Data.IdentityModels.ApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("PawMates.Infrastructure.Data.Models.Post", b =>
                {
                    b.HasOne("PawMates.Infrastructure.Data.IdentityModels.ApplicationUser", "Creator")
                        .WithMany()
